...
const terms = [
  {
    ...
    def: "A preliminary look at your credit profile that does NOT affect your credit score. Used to estimate your eligibility.",
  },
  {
    term: "Affordability check",
    def: "An assessment of your income vs. expenses to determine how much you can responsibly afford to repay each month.",
  },
  {
    term: "Net income",
    def: "Your take-home pay after tax, UIF and other deductions.",
  },
  {
    term: "Gross income",
    def: "Your total income before any deductions or taxes.",
  },
  {
    term: "Pre-qualification",
    def: "An early indication of finance eligibility, before a full application is submitted to a financial institution.",
  },
];
